...
public class BookDao extends AbstractDao<Book, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Published = new Property(4, Integer.class, "published", false, "PUBLISHED");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Book entity) {
        ...
        Integer published = entity.getPublished();
        if (published != null) {
            stmt.bindLong(5, published);
        }
    }
    ...
    public Book readEntity(Cursor cursor, int offset) {
        Book entity = new Book( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getInt(offset + 4) // published
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Book entity, int offset) {
        ...
        entity.setPublished(cursor.isNull(offset + 4) ? null : cursor.getInt(offset + 4));
     }
